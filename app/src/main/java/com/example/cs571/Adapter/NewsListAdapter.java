...
public class NewsListAdapter extends RecyclerView.Adapter<NewsListAdapter.NewsItemViewHolder> {
    ...
    public NewsListAdapter(ArrayList<NewsItem> mNewsList, RecyclerView mRecycler) {
    ...
    public void onBindViewHolder(@NonNull final NewsItemViewHolder holder, final int position) {
        ...
        holder.mDateAndSection.setText(cur.get_time_and_section());
        ...
        Picasso.with(holder.mImageView.getContext()).load(cur.getImage()).centerCrop().resize(150, 150).into(holder.mImageView);
    }
